...
class _MyAppState extends State<MyApp> {
  final _questions = const [
    ...
    {
      'questionText': 'Q5. Is Flutter for Web and Desktop available in the stable version?',
      'answers': [
        {'text': 'Yes', 'score': -2},
        {'text': 'No', 'score': 10},
      ],
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: const Color(0x0ff00e88), // Use Color class to set the background color
